...
class ConfigurationManager:
    ...
    def get_training_config(self) -> TrainingConfig:
        ...
        preparing_base_model = self.config.prepare_base_model
        params = self.param
        ...
        training_config = TrainingConfig(
            ...
            updated_base_model_path = Path(preparing_base_model.updated_base_model_path),
    ...
    def get_evaluation_config(self) -> EvaluationConfig:
        eval_config = EvaluationConfig(
            ...
            mlflow_uri = "https://dagshub.com/riyamsarfaraz/Chest_Cancer_Classification_using_mlflow_dvc-.mlflow",
